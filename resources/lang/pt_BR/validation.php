...
return [
    ...
    | pela classe de validador. Algumas destas regras têm múltiplas versões
    ...
    */
    ...
    | Isso torna rápido especificar uma linha de idioma personalizada
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar o espaço reservado
    | de atributo por algo mais amigável, como "Endereço de E-Mail" em vez
    | de "email". Isso simplesmente nos ajuda a tornar nossa mensagem
    | mais expressiva.
    |
    */
