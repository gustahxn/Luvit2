<?php $__env->startSection('title', 'Criar Conta - Luvit'); ?>

<?php echo app('Illuminate\Foundation\Vite')(['resources/js/pages/auth/register.js']); ?>
...
<section class="register-section">
    ...
    <div class="register-form-side">
        <div class="register-container">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" id="registerForm" class="enhanced-form">
                <?php echo csrf_field(); ?>

                <div class="form-step active" id="step1">
                    <div class="input-group">
                        <label for="name" class="input-label">Nome Completo</label>
                        <input type="text" name="name" id="name" class="enhanced-input" placeholder="Digite seu nome completo" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus>
                    </div>

                    <div class="input-group">
                        <label for="username" class="input-label">Nome de Usuário</label>
                        <input type="text" name="arroba" id="username" class="enhanced-input" placeholder="Crie um nome de usuário (ex: seu_nome)" value="<?php echo e(old('arroba')); ?>" required autocomplete="username">
                    </div>

                    <div class="input-group">
                        <label for="email" class="input-label">Email</label>
                        <input type="email" name="email" id="email" class="enhanced-input" placeholder="Digite seu email" value="<?php echo e(old('email')); ?>" required autocomplete="email">
                    </div>
                ...
                <div class="form-step" id="step2" style="display: none;">
                    ...
                    <div class="input-group">
                        ...
                        <textarea name="bio" id="bio" rows="4" class="enhanced-input" placeholder="Fale um pouco sobre você..." maxlength="255"><?php echo e(old('bio')); ?></textarea>
            ...
            <div class="auth-links">
                <p class="text-sm text-gray-400">
                    Já tem uma conta? 
                    <a href="<?php echo e(route('login')); ?>" class="auth-link primary-link text-rose-600">Fazer login</a>
                </p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gustahxn/Stuff/coding/Luvit/resources/views/auth/register.blade.php ENDPATH**/ ?>