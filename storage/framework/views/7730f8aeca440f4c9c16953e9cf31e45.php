<?php $__env->startSection('title','Página Inicial - Luvit'); ?>
...
<section class="relative min-h-[90vh] overflow-hidden hero-section">
    <div class="absolute inset-0 -z-10">
        <?php if(!empty($filmes[0]['backdrop_path'])): ?>
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat"
             style="background-image: url('https://image.tmdb.org/t/p/original<?php echo e($filmes[0]['backdrop_path']); ?>')">
        </div>
        <?php endif; ?>
            ...
            <div class="space-y-8 animate-fade-in-up">
                <div class="space-y-4">
                    ...
                    <h1 class="text-5xl md:text-7xl font-black text-white leading-tight">
                        <?php echo e($filmes[0]['title']); ?>

                    </h1>
                    
                    <div class="flex flex-wrap items-center gap-6 text-white/80">
                        <?php if(!empty($filmes[0]['vote_average'])): ?>
                        <div class="flex items-center gap-2">
                            <div class="flex items-center gap-1">
                                <svg class="w-6 h-6 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                </svg>
                                <span class="text-lg font-bold text-white"><?php echo e(number_format($filmes[0]['vote_average'],1)); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <?php if(!empty($filmes[0]['release_date'])): ?>
                        <div class="flex items-center gap-2">
                            <span class="text-lg"><?php echo e(\Carbon\Carbon::parse($filmes[0]['release_date'])->format('Y')); ?></span>
                        </div>
                        <?php endif; ?>
                        
                        <?php if(!empty($filmes[0]['genre_ids'])): ?>
                        <div class="flex items-center gap-2">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="/filme/<?php echo e($filmes[0]['id'] ?? ''); ?>" 
...
<section id="movies" class="py-6 md:py-6 relative">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
            <?php $__currentLoopData = collect($filmes)->slice(12, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="/filme/<?php echo e($filme['id'] ?? ''); ?>" class="group block relative movie-card">
                <div class="relative rounded-2xl overflow-hidden glass-card-subtle hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:shadow-black/40" 
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                        <h3 class="font-semibold text-white text-sm line-clamp-2 mb-2"><?php echo e($filme['title']); ?></h3>
                        <?php if(!empty($filme['vote_average'])): ?>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="text-xs font-semibold text-white"><?php echo e(number_format($filme['vote_average'],1)); ?></span>
                                </div>
                                <?php if(!empty($filme['release_date'])): ?>
                                    <span class="text-xs text-white/70"><?php echo e(substr($filme['release_date'],0,4)); ?></span>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      ?>
          ...
          <div class="grid grid-cols-3 gap-4">
              <?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $game): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="poster-grid-item" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                      <img src="<?php echo e($game['image']); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/user/htdocs/srv1152600.hstgr.cloud/resources/views/index.blade.php ENDPATH**/ ?>