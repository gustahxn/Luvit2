<?php $__env->startSection('title', 'Descubra jogos incríveis - Luvit'); ?>
                        ...
                        <ul class="splide__list">
                            <?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $game): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="splide__slide">
                                    <a href="<?php echo e(route('games.show', $game['id'])); ?>" class="group block relative movie-card">
                                        <div class="relative rounded-2xl overflow-hidden glass-card-subtle hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:shadow-black/40" 
                                            ...
                                            <div class="aspect-[2/3] overflow-hidden bg-gray-800">
                                                <?php if(!empty($game['background_image'])): ?>
                                                    <img src="<?php echo e($game['background_image']); ?>" 
                                            ...
                                            <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
                                                <div class="absolute bottom-4 left-4 right-4 space-y-3 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div class="space-y-1">
                                                            <?php if(!empty($game['rating']) && $game['rating'] > 0): ?>
                                                            ...
                                                            <?php if(!empty($game['released'])): ?>
                                                                <div class="text-xs text-white/80">
                                                                    <?php echo e(\Carbon\Carbon::parse($game['released'])->year); ?>
                                                    ...
                                                    <?php if(!empty($game['platforms']) && count($game['platforms']) > 0): ?>
                                                        <div class="inline-block mb-2 px-3 py-1 rounded-full bg-green-500/20 border border-green-500/30 text-green-300 text-xs font-medium">
                                                            <?php echo e($game['platforms'][0]['platform']['name'] ?? 'Multi-plataforma'); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        <div class="glass-card rounded-3xl p-8 md:p-12 space-y-8">
            ...
            <div class="flex gap-4 justify-center flex-wrap">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('register.form')); ?>" class="shine group inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-green-600 to-green-500 text-white font-semibold text-lg transition-all duration-300 hover:-translate-y-1">
                        <svg class="w-6 h-6 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gustahxn/Stuff/coding/Luvit/resources/views/games/index.blade.php ENDPATH**/ ?>