<?php $__env->startSection('title', 'Login - Luvit'); ?>

<?php echo app('Illuminate\Foundation\Vite')(['resources/js/pages/auth/login.js']); ?>
...
<section class="login-section">
    ...
    <div class="login-form-side">
        <div class="login-container">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" id="loginForm" class="enhanced-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="remember-section">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="forgot-link">Esqueceu sua senha?</a>
                    <?php endif; ?>
                </div>
            ...
            <div class="auth-links">
                <p class="text-sm text-gray-400">
                    Não tem uma conta? 
                    <a href="<?php echo e(route('register')); ?>" class="auth-link primary-link text-rose-600">Criar conta</a> 
                </p>
            </div>
            
            <div class="flex justify-center w-full">
                <a href="<?php echo e(route('home.index')); ?>" class="auth-link primary-link text-rose-600 mt-2">Voltar</a>
            </div>
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gustahxn/Stuff/coding/Luvit/resources/views/auth/login.blade.php ENDPATH**/ ?>