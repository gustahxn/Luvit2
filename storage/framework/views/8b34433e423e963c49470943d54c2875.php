...
<div class="max-w-3xl mx-auto mt-6 mb-18 bg-gray-900/80 backdrop-blur-md p-8 rounded-2xl border border-white/10 shadow-2xl">
  ...
  <form method="POST" action="<?php echo e(route('lists.store')); ?>" id="create-list-form">
    <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
        <p class="text-rose-400 text-sm mt-1"><?php echo e($message); ?></p>
      <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="flex gap-3">
      ...
      <a href="<?php echo e(route('lists.index')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gustahxn/Stuff/coding/Luvit/resources/views/lists/create.blade.php ENDPATH**/ ?>