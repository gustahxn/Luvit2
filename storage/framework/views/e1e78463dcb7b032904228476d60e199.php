<?php $__env->startSection('title', 'Seguidores de ' . $user->name); ?>
...
<div class="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-white">Seguidores de <?php echo e($user->name); ?></h1>
        <p class="text-gray-400 mt-2"><?php echo e($followers->total()); ?> <?php echo e($followers->total() == 1 ? 'seguidor' : 'seguidores'); ?></p>
    </div>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $followers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $follower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('profile.show', $follower->arroba)); ?>">
                        <?php if($follower->profile_picture): ?>
                            <img src="<?php echo e(asset('storage/' . $follower->profile_picture)); ?>" 
                    ...
                    <div>
                        <a href="<?php echo e(route('profile.show', $follower->arroba)); ?>" class="text-white font-semibold hover:text-gray-400">
                            <?php echo e($follower->name); ?>

                        </a>
                        <p class="text-sm text-gray-400"><?php echo e('@' . $follower->arroba); ?></p>
                    </div>
                </div>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->id() !== $follower->id): ?>
                        <button 
                            class="mini-follow-btn px-4 py-2 rounded-lg text-sm font-medium transition-colors <?php echo e(auth()->user()->isFollowing($follower->id) ? 'bg-gray-700 hover:bg-gray-600 text-white' : 'bg-rose-600 hover:bg-rose-700 text-white'); ?>"
                            data-arroba="<?php echo e($follower->arroba); ?>"
                            data-following="<?php echo e(auth()->user()->isFollowing($follower->id) ? 'true' : 'false'); ?>">
                            <?php echo e(auth()->user()->isFollowing($follower->id) ? 'Seguindo' : 'Seguir'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/gustahxn/Stuff/coding/Luvit/resources/views/profile/followers.blade.php ENDPATH**/ ?>